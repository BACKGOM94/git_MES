...
$(document).ready(
	function() {
		...
		//IBSheet 생성 영역
		iB_Sheet_Make("M5102060_1_Sheet","${M5102060_1_Sheet}","100%");	
		
		doAction('M5102060_1_Sheet','search');
			...
			<div class="layout-grid">
				<div class="grid">
					...
					<div class="title">
						...
						<div class="title-set">
							<p>조회건수 : <span id="M5102060_1_Sheet_totalcnt"></span> 건</p>
						</div>
					</div>
					<div class="clear"></div>
					<%-- title --%>
