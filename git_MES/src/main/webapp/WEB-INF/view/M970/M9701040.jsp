...
$(document).ready(
	...
	function() {
		...
		//검색일자 오늘날짜로
		$('#check_DT').val(get_date('today'));
		
		//IBSheet 생성 영역
		iB_Sheet_Make("M9701040_1_Sheet","${M9701040_1_Sheet}","100%");	
		iB_Sheet_Make("M9701040_2_Sheet","${M9701040_2_Sheet}","100%");	
		doAction('M9701040_1_Sheet','search');
		doAction('M9701040_2_Sheet','search');
	...
	function M9701040_2_Sheet_OnSearchEnd() { 
		var value = 0;
		
		for (var i = 1; i < M9701040_2_Sheet.RowCount() + 1; i++) {
			value += M9701040_2_Sheet.GetCellValue(i,'inventory');
		}
		...
		<div class="page-content">
			...
			<div class="inquiry-box">
				<table class="table">
					<tbody>
						<tr class="line">			
							<th class="required"><label for="">검색 일자</label></th>
							<td>								
								<input type="Date" class="form width40" title="검색일자" id="check_DT" name="check_DT" onchange="doAction('M9701040_1_Sheet', 'search'); return false;"/>
							</td>
			...
			<div class="layout-grid">
					...
					<div class="title">
						...
						<div class="btn-y-group">
							<ul class="list-inline">	
								<li><a title="인쇄" class="btn-print" href="#" onclick="doAction('M9701040_1_Sheet', 'print'); return false;" role="button">인쇄</a></li>						
							</ul>
						</div>	
						<div class="title-set">			
						</div>
				...
				<div class="grid-left45">
					...
					<div class="title">
						...
						<div class="btn-y-group">
							<ul class="list-inline">	
								<li><a title="인쇄" class="btn-print" href="#" onclick="doAction('M9701040_2_Sheet', 'print'); return false;" role="button">인쇄</a></li>						
							</ul>
						</div>	
						<div class="title-set">			
						</div>
