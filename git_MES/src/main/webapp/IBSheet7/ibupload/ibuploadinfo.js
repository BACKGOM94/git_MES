...
ibleaders.ibupload = {
    ...
    //userAgent
    userAgent : [{"IBUpload":"IBUpload"},{"AjaxComponentVersion":"7.3"}], // CORS 적용시 undefined 로 설정해야 됨.
    /* 서버 경로 설정 */
    //uploadServerUrl: "/gom/IBSheet7/ibupload/jsp/ibupload.jsp",
    //downloadServerUrl: "/gom/IBSheet7/ibupload/jsp/ibdownload.jsp",
    uploadServerUrl: gv_getContextRootPath + "IBSheet7/ibupload/jsp/ibupload.jsp",
    downloadServerUrl: gv_getContextRootPath + "IBSheet7/ibupload/jsp/ibdownload.jsp",
...
*/
    ...
    onUploadData: function(serverResponeObject, serverResponeText){
     try{
    	var rtnObj = {};
    	rtnObj["ibupload"] = serverResponeObject["ibupload"]["ResultJSON"]["ibupload"];
    	rtnObj["etcdata"] = serverResponeObject["etcdata"];
    	return rtnObj;
     }catch(ex){
...
function _IBUpload_mFileName2Date(FileUrl) {
    ...
    var AmPm = (result.substring(9, 11) * 1 < 12) ? ibleaders.ibupload.message[ibleaders.ibupload.locale]["TEXT-DateAm"] : ibleaders.ibupload.message[ibleaders.ibupload.locale]["TEXT-DatePm"];
